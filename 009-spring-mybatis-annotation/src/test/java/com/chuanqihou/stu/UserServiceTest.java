...
public class UserServiceTest {
    ...
    public void testInsertUser() {
        ApplicationContext ac = new ClassPathXmlApplicationContext("spring-context-transaction-annotation.xml");
        UserService userService = ac.getBean(UserService.class);
        userService.saveUser(new User(null, "yyj", "1", "18774158485", "职位", 2000F, "北京"));
    }
